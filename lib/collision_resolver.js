...
import { gameSounds } from "./game_entities";
...
export const resolveCollision = (circle, other) => {
  if (other instanceof Circle) {
    ...
    other instanceof Puck ? gameSounds.oof.play() : gameSounds.kick.play();
  } else if (other instanceof Wall) {
    seperateCirWall(circle, other);
    resolveCirWallCollision(circle, other);
    circle instanceof Ball ? gameSounds.kick.play() : gameSounds.oof.play();
  }
};
