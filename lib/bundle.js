...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__collision_detector__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__render__ = __webpack_require__(15);
...
class Game {
  constructor() {
    this.currentPlayer = __WEBPACK_IMPORTED_MODULE_2__game_entities__["b" /* playerList */][0];
    this.score = { [__WEBPACK_IMPORTED_MODULE_2__game_entities__["b" /* playerList */][0]]: 0, [__WEBPACK_IMPORTED_MODULE_2__game_entities__["b" /* playerList */][1]]: 0 };
    this.environment = new __WEBPACK_IMPORTED_MODULE_0__environment_js__["a" /* default */]();
    this.canvas = document.createElement("canvas");
    this.context = this.canvas.getContext("2d");
    this.setupCanvas();
    this.ui = new __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* default */](this.canvas, this.context, __WEBPACK_IMPORTED_MODULE_2__game_entities__["b" /* playerList */], this.environment);
  ...
  setupCanvas() {
    ...
    __WEBPACK_IMPORTED_MODULE_2__game_entities__["a" /* gameEntities */].forEach(entity => {
      this.environment.addEntity(entity);
    });
    this.environment.allEntities.forEach(entity => {
      Object(__WEBPACK_IMPORTED_MODULE_4__render__["b" /* render */])(this.context, entity);
    });
  }
  setupEventListeners() {
  ...
  nextFrame() {
    Object(__WEBPACK_IMPORTED_MODULE_4__render__["a" /* clear */])(this.canvas, this.context);
    this.environment.allEntities.forEach(entity => {
      entity.nextFrame;
      Object(__WEBPACK_IMPORTED_MODULE_4__render__["b" /* render */])(this.context, entity);
    });
    Object(__WEBPACK_IMPORTED_MODULE_3__collision_detector__["a" /* handleCollisions */])(this.environment);
