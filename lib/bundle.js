...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__collision_detector__ = __webpack_require__(13);
...
environment.allEntities.forEach(entity => {
  Object(__WEBPACK_IMPORTED_MODULE_2__render__["b" /* render */])(context, entity);
});
...
const nextFrame = () => {
  Object(__WEBPACK_IMPORTED_MODULE_2__render__["a" /* clear */])(canvas, context);
  environment.allEntities.forEach(entity => {
    entity.nextFrame;
    Object(__WEBPACK_IMPORTED_MODULE_2__render__["b" /* render */])(context, entity);
  });
  const collisions = Object(__WEBPACK_IMPORTED_MODULE_1__collision_detector__["a" /* detectCollisions */])(environment);
